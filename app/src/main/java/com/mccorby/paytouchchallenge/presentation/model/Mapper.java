...
public class Mapper {
    ...
    public static Actor transformActor(com.mccorby.paytouchchallenge.presentation.model.PresentationActor presentationActor) {
        ...
        for (com.mccorby.paytouchchallenge.presentation.model.PresentationWork work : presentationActor.getKnownFor()) {
...
//        work.setMediaType(apiWork.getMediaType());
    ...
    public static PresentationActor modelToData(Actor modelActor) {
        ...
        for (Work work : modelActor.getKnownFor()) {
            works.add(com.mccorby.paytouchchallenge.presentation.model.Mapper.modelToData(work));
        }
        actor.setKnownFor(works);
